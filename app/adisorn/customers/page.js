      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="overflow-x-auto rounded-2xl bg-white shadow-sm">
          <div className="min-w-[1320px]">
            <div className="grid grid-cols-[48px_1.1fr_1fr_1fr_1fr_0.9fr_430px] gap-4 bg-zinc-900 px-5 py-4 font-semibold text-white">
              ...
              filteredCustomers.map((customer, index) => {
                ...
                return (
                  <div
                    ...
                    className={`grid grid-cols-[48px_1.1fr_1fr_1fr_1fr_0.9fr_430px] items-center gap-4 border-t px-5 py-4 transition ${
